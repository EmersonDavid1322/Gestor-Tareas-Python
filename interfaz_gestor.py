        ...
        if marcar_tarea is None:
            ...
            if marcar_tarea.tipo == "Unica":
                if marcar_tarea.estado == "Completada":
                    self.info.configure(text="Tarea ya marcada")
                ...
                if str(fecha_m) in marcar_tarea.estado:
                    self.info.configure(text="Tarea ya marcada por hoy")
                    messagebox.showwarning("Completar",f"La tarea {marcar_tarea.nombre} ya a sido marcada")
                    ...
                    if marcar_tarea.prioridad == "Alta":
                        ...
                        puntos_v += puntaje
                    self.mensaje.configure(text=f"¡Felicidades! Tu puntaje de diciplina subio a: {puntaje} sigue asi")
                    messagebox.showinfo("Completar","¡Felicidades! Has completado el habito, sigue asi")
